...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/digimon-world-2-recomp/total)](https://github.com/Alexbeav/digimon-world-2-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/digimon-world-2-recomp/latest/total)](https://github.com/Alexbeav/digimon-world-2-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/digimon-world-2-recomp)](https://github.com/Alexbeav/digimon-world-2-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Digimon World 2** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/RetroPortingToolKit/recomp-ui).

This is an owned-input setup kit. You supply your own SLUS-01193 disc image
...
|---|---|
| Region | USA |
| Disc serial | SLUS-01193 |
| Discs | 1 |
| Supported dump | Redump `Digimon World 2 (USA).cue` as CUE/BIN or CHD |
| BIOS | SCPH-1001 (USA), 524288 bytes, SHA-256 `71af94d1e47a68c11e8fdb9f8368040601514a42a5a399cda48c7d3bff1e99d3` |

## Setup

1. Download the setup ZIP for your platform from [Releases](https://github.com/Alexbeav/digimon-world-2-recomp/releases)
   and extract it into a writable folder.
2. Start `Digimon_World_2` (`.exe` on Windows).
...
named `diagnostic-mode.txt` next to `Digimon_World_2.exe` and start the game as
usual, or run `Digimon_World_2.exe --diagnostic`. Reproduce the problem, quit, then
run `Digimon_World_2.exe --collect-diagnostics`: it writes `diagnostics-<date>.zip`
