...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Digimon World 2",
    .project_root_env = "DIGIMON_WORLD_2_PROJECT_ROOT",
    .build_dir_env = "DIGIMON_WORLD_2_BUILD_DIR",
    .force_setup_env = "DIGIMON_WORLD_2_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_011.93_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Digimon_World_2",
    .prepare_note =
